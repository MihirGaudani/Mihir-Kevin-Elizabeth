...
while count < runtime:
    ...
    if variable_type == 1:
         ...
         data1 = float(aqdata["pm10 standard"])
         data2 = float(aqdata["pm25 standard"])
         data3 = float(aqdata["pm100 standard"])
         data4 = float(aqdata["pm10 env"])
         data5 = float(aqdata["pm25 env"]) 
         data6 = float(aqdata["pm100 env"])
         data7 = float(aqdata["particles 03um"])
         data8 = float(aqdata["particles 05um"])
         data9 = float(aqdata["particles 10um"])
         data10 = float(aqdata["particles 25um"])
         data11 = float(aqdata["particles 50um"])
         data12 = float(aqdata["particles 100um"])
         data13 = float(bme680.temperature)
         data14 = float(bme680.relative_humidity)
         data15 = float(bme680.pressure)
         data16 = float(bme680.altitude)
